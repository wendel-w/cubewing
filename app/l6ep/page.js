        ...
        <>
            ...
            <div className="description">
                <p className="title"> Description: </p>
                    ...
                    <p>You can view the source i used  <a href='https://docs.google.com/spreadsheets/d/1_V7I5yWftss7ezdfhs43eMoon8S3I6z6boeQmiH6lgU/edit?gid=1941046113#gid=1941046113'>here</a> and also check what <a href="https://www.speedsolving.com/wiki/index.php?title=LSE#L6EP">SpeedSolving.com</a> says.</p>
            ...
            <AlgGrid algSource={"/algorithms/l6ep/l6ep_.json"} SvgComponent={GetLseCaseSVG} />
        </>
    )
}